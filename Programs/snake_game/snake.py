...
class Snake:
    ...
    def generate_positions(self, position):
        new_x = self.starting_position[0] + position[0]
        new_y = self.starting_position[1] + position[1]
        new_pos = (new_x, new_y)
        return new_pos
    ...
    def create_snake(self):
        for position in STARTING_POSITIONS:
            new_position = self.generate_positions(position)
    ...
    def add_segment(self):
        ...
        self.create_segment((x_pos, y_pos))
